...
reversion.register(Location, follow=['call_location', 'inspection_location', 'offence_location'])
reversion.register(MapLayer, follow=[])
#reversion.register(CallEmail_referrer, follow=[])
reversion.register(CallEmail, follow=['form_data_records', 'documents', 'comms_logs', 'action_logs', 'legal_case_call_email', 'inspection_call_email', 'offence_call_eamil'])
