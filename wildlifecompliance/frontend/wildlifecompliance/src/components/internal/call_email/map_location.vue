    ...
    <div>
        <div class="map-wrapper">
            ...
            <div class="basemap-button">
                <img :id="idBasemapSat" class="basemap-button-img" src="/static/wildlifecompliance_vue/img/satellite_icon.jpg" @click.stop="setBaseLayer('sat')" />
                <img :id="idBasemapOsm" class="basemap-button-img" src="/static/wildlifecompliance_vue/img/map_icon.png" @click.stop="setBaseLayer('osm')" />
            </div>
