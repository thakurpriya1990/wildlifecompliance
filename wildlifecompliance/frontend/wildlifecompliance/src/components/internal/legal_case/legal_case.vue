    ...
    <div class="container">
      <div class="row">
                          ...
                          <div class="row">
                            <div v-if="statusId === 'open'" class="col-sm-12">
                              <select :disabled="!legal_case.user_in_group" class="form-control" v-model="legal_case.assigned_to_id" @change="updateAssignedToId()">
                                <option  v-for="option in legal_case.inspection_team" :value="option.id" v-bind:key="option.id">
                                  {{ option.full_name }} 
                                </option>
                              </select>
                            </div>
                          ...
                          <FormSection :formCollapse="false" label="Running Sheet" Index="0">
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-sm-9">
                                  <input :readonly="readonlyForm" class="form-control" v-model=""/>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-sm-9">
                                  <textarea :readonly="readonlyForm" class="form-control" v-model=""/>
                                </div>
                              </div>
                            </div>
        ...
        <div v-if="sanctionOutcomeInitialised">
            <SanctionOutcome ref="sanction_outcome" :parent_update_function="loadLegalCase"/>
        </div>
